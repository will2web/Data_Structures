...
pub fn main() !void {
    ...
    //     debug_print("placeholder_Node = &head_Node;", .{});
    //     debug_print("\nplaceholder_Node value is {d}\t\t", .{placeholder_Node.?.value});
    //     debug_print("placeholder_Node Address is {*}\n", .{placeholder_Node});
    //     debug_print("while_loop_pointer value is {d}\t\t\t", .{while_loop_pointer.?.value});
    //     debug_print("while_loop_pointer Address is\t {*}\n\n", .{while_loop_pointer});

    //     head_Node = subsequent_Node.?.*;
    //     debug_print("head_Node = subsequent_Node.?.*;", .{});
    //     debug_print("\nhead_Node value is {d}\t\t", .{head_Node.value});
    //     debug_print("head_Node Address is {*}\n", .{&head_Node});
    //     debug_print("subsequent_Node value is {d}\t\t\t", .{subsequent_Node.?.value});
    //     debug_print("subsequent_Node Address is\t {*}\n\n", .{subsequent_Node.?.next_node_pointer});

    //     while_loop_pointer.?.next_node_pointer = placeholder_Node;
    //     debug_print("while_loop_pointer.?.next_node_pointer = placeholder_Node;", .{});
